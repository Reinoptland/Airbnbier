...
Room.create([
  {name: "Room 1", description: "Nice student room ", price: 34,  image_url: "/assets/room1.jpg", location_id: 1 , user: rein},
  {name: "Room 2", description: "Cheap student room ", price: 20, image_url: "/assets/room2.jpg", location_id: 1, user: rein},
  {name: "Room 3", description: "Student room for party ppl!", price: 22, image_url: "/assets/room3.jpg", location_id: 2, user: rein},
  {name: "Room 4", description: "Student room with a nice view", price: 67, image_url: "/assets/room4.jpg", location_id: 4, user: julian},
  {name: "Room 5", description: "Luxurious student room", price: 76, image_url: "/assets/room5.jpg", location_id: 2, user: timmo},
  {name: "Room 6", description: "Small student room with nice roommates", price: 34, image_url: "/assets/room6.jpg", location_id: 3, user: christiaan},
